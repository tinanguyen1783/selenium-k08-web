...
public class BillingAddressComponent extends Component {
    ...
    public BillingAddressComponent(WebDriver driver, WebElement webElement) {
    ...
    public void selectCountry(String country){
        ...
        webDriverWait.until(ExpectedConditions.invisibilityOf(component.findElement(loadingStateProgressBarSel)));
    }
    ...
    public void clickOnContinueBtn(){
        ...
        continueBtn.click();
        webDriverWait.until(ExpectedConditions.invisibilityOf(continueBtn));
    }
